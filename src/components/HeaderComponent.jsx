        ...
        <nav className='navHeader'>
            ...
            <div className="right-buttons">
                <ul>
                  ...
                  <li>{!isAuthenticated &&<a className='headerLoginButton' href="/login">LOGIN</a>}</li>
                  <li>{isAuthenticated && <a href="" className="headerLoginButton" onClick={logout}>Logout</a>}</li>
